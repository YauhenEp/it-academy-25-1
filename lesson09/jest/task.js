...
async function filterLongWords(wordArray, wordLength) {
  let newArr = [];
...
function countPropertyValues(arrayOfObjects, propertyName) {
...
module.exports = { countPropertyValues, filterLongWords, reverseWord }